...
date: 2026-01-10
tags: [pcb-design, kicad, usb-c, embedded, mechanical-keyboard]
...
Pocketboard is a compact, standalone mechanical keyboard designed for portable, on-the-go use. The project is inspired by the **HandiPi** keyboard by BrickBots, but redesigned from the ground up with a focus on **modern components, surface-mount assembly, and real-world usability**.
